...
export default class HSLClock extends React.Component {
  render () {
    let hue = Math.floor(this.props.currentHour / 23 * 360)
    let sat = this.props.currentMinute + 20
    let light = this.props.currentSecond + 20
    ...
    let description = `This clock displays the current time as an HSL value in a simliar fashion to the RGB Clock.
