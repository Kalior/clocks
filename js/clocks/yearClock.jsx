...
export default class YearClock extends React.Component {
  ...
  render() {
    ...
    var canvas;
    if (this.props.isTop) {
      canvas = <canvas id="year-canvas-top" className="year-clock" height="200" width="200"></canvas>;
    } else {
      canvas = <canvas id="year-canvas" className="year-clock" height="200" width="200"></canvas>;
    }
    return(
