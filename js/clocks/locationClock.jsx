...
export default class LocationClock extends React.Component {
  ...
  render() {
    var description = "Since a lot of the clocks here actually display time, even if so in a confounding way, this one does not. " +
      "Instead, it uses geolocation to find your location and then displays your latitude, longitude, and altitude rounded down " +
      ...
      "your east-west distance to Greenwich is great. I don't think the last number requires any further explanation.";
    return(
      <div className="clock">
